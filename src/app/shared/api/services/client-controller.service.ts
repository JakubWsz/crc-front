...
export class ClientControllerService extends BaseService {
  ...
  /**
   * Path part for operation getFilteredClients2
   */
  static readonly GetFilteredClients2Path = '/client';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getFilteredClients2()` instead.
   *
   * This method doesn't expect any request body.
   */
  getFilteredClients2$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ClientControllerService.GetFilteredClients2Path, 'get');
    if (params) {
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `getFilteredClients2$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getFilteredClients2(params: {
    specification: ClientSpecification;
    pageable: Pageable;
    context?: HttpContext
  }
    ...
    return this.getFilteredClients2$Response(params).pipe(
