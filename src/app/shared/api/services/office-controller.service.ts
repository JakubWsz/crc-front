...
export class OfficeControllerService extends BaseService {
  ...
  /**
   * Path part for operation getPagedOffices
   */
  static readonly GetPagedOfficesPath = '/office';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getPagedOffices()` instead.
   *
   * This method doesn't expect any request body.
   */
  getPagedOffices$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, OfficeControllerService.GetPagedOfficesPath, 'get');
    if (params) {
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `getPagedOffices$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getPagedOffices(params: {
    specification: OfficeSpecification;
    pageable: Pageable;
    context?: HttpContext
  }
    ...
    return this.getPagedOffices$Response(params).pipe(
